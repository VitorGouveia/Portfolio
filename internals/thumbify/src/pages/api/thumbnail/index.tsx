...
const handler = async (request: NextRequest) => {
  ...
  const { title, description, company, coverUrl } = query.parse(params);
  ...
  return new ImageResponse(
    (
      <div
        ...
        tw="h-full w-full py-20 flex items-center justify-center"
      >
        <main
          style={{
            width: "100%",
        ...
        >
          ...
          >
            <div
              tw="w-[64px] h-[64px] flex items-center justify-center"
              style={{ color: system.base }}
            >
              {comapniesIcons[company]}
            </div>
          ...
          <header tw="flex flex-col items-center gap-2">
            <h1
              style={{
                color: system.title,
                fontSize: "60px",
            ...
            <p
              style={{ color: system.base }}
              tw={`text-center text-[30px] font-normal`}
            >
              {description}
            </p>
          </header>
          ...
          {coverUrl && (
            <section
              ...
              tw="flex items-center justify-center gap-16 w-full h-[420px] border border-system-support rounded-[8px]"
            >
              <img
                tw="w-full h-full object-cover brightness-90 rounded-[8px]"
                src={coverUrl}
                alt="Banner image"
